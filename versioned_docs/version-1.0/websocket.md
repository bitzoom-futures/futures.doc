...
ws.send(JSON.stringify({
  method: 'SUBSCRIBE',
  params: ['ETH/USDT@ticker', 'ethusdt@ticker'],
  id: 1
}));
```
...
class BitzoomWebSocket:
    ...
    def on_open(self, ws):
        print("Connected")
        self.subscribe(['ETH/USDT@ticker', 'ETH/USDT@trade', 'ETH/USDT@kline_1m'])
