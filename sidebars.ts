  ...
  openApiSidebar: [
    ...
    // },
    {
      ...
      link: {
        ...
        title: 'Bitzoom API',
        description:
          'This is a sample server Bitzoom server. You can find out more about Swagger at http://swagger.io or on irc.freenode.net, #swagger. For this sample, you can use the api key special-key to test the authorization filters.',
